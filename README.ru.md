...
# Использование
kataraktaCS задумана (более-менее) интуитивной для использования, но если Вы что-то не понимаете, то загляните на [Вики](https://github.com/vazhka-dolya/kataraktaCS/wiki). Ещё учтите, что некоторый текст покажет дополнительную информацию, если на него навести курсор.
